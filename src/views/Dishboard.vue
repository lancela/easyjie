<template>
  <div class="app-container">
    ...
    <el-card style="margin:20px">
      <div>
        <div id="jinji" style="height:400px;"></div>
      </div>
    </el-card>
    <!-- 第三组图标展示 -->
    <div style="padding:20px">
      <el-row :gutter="40" class="tu-group">
        <el-col :xs="24" :sm="12" :lg="8" class="card-tu-col">
          <el-card>
            <div id="leida" style="height:200px;"></div>
          </el-card>
        </el-col>
        <el-col :xs="24" :sm="12" :lg="8" class="card-tu-col">
          <el-card>
    ...
    <!-- 最下面的表格列表数据的展示 -->
    <div style="padding:20px">
      <el-row :gutter="40" class="table-group">
        <!-- 表格 -->
        <el-col :xs="24" :sm="24" :lg="12" class="card-tu-col">
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="addressId" label="ID" width="180"></el-table-column>
            <el-table-column prop="total" label="总数量" width="180"></el-table-column>
            <el-table-column label="状态">
              <template slot-scope="scope">
                <!-- style="{'line-height': (index == 1 ? '25px':'50px')}" -->
                <el-tag :type="(scope.row.status=='待派单')?'info':'success'">{{scope.row.status}}</el-tag>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
        <!-- 列表 -->
        <el-col :xs="24" :sm="12" :lg="6" class="card-tu-col">
          <todo-list />
        </el-col>
        <!-- 图 -->
        <el-col :xs="24" :sm="12" :lg="6" class="card-tu-col" style="position:re">
          <!-- 上边的图片 -->
          <div class="img">
            <img src="../assets/image/bkimg/indexbk.jpg" alt />
          </div>
          <!-- 中间部分 -->
          <div class="circlePa">
            <div class="circle"></div>
            <div class="circle circleinner"></div>
          </div>
...
export default {
  ...
  mounted() {
    // 连接el和二chart
    var jinji = echarts.init(document.getElementById("jinji"));
    ...
    // 使用刚指定的配置项和数据显示图表。
    jinji.setOption(jinjioption);
    leida.setOption(leidaoption);
...
.circlePa {
  ...
  .circleinner {
    ...
    background-image: url("../assets/image/gif1.gif");
  }
}
</style>
<style lang="scss" scoped>
